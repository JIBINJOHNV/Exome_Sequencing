...
Depth['VariantAlleleFrequency']=Depth['AltAlleleDepth']/Depth['TotalDepth']
...
AnnovarFile[['ReferenceAlleleDepth', 'AltAlleleDepth','VariantAlleleFrequency', 
             'RefinedGenotype']]=Depth[['ReferenceAlleleDepth', 'AltAlleleDepth','VariantAlleleFrequency', 'RefinedGenotype']]
...
ColumnOrder=['#Chr', 'Start', 'End', 'Ref', 'Alt', 'Gene.refGene', 'Func.refGene', 'ExonicFunc.refGene', 'GeneDetail.refGene',
 ...
 'RefinedGenotype','Zygosity','Depth', 'ReferenceAlleleDepth', 'AltAlleleDepth', 'VariantAlleleFrequency', 
